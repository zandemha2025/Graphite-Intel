    ...
    rollupOptions: {
      output: {
        manualChunks(id) {
          ...
          if (id.includes("/pages/workflow")) return "pages-workflows";
          if (id.includes("/pages/board") || id.includes("/pages/boards")) return "pages-boards";
          if (id.includes("/pages/notebook")) return "pages-notebooks";
          if (id.includes("/pages/context")) return "pages-context";
        },
      },
    },
  },
