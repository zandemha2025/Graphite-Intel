...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-[var(--border)] bg-[var(--surface-secondary)]/50 font-medium [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-[var(--border)] transition-colors hover:bg-[var(--surface-secondary)]/50 data-[state=selected]:bg-[var(--accent-muted)]",
      className
    )}
    {...props}
  />
