  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative z-10 w-full max-w-2xl rounded-xl border border-[#27272A] bg-[#18181B] p-6 shadow-lg">
          ...
          {TEMPLATES.map((tpl) => {
            ...
            return (
              <button
                ...
                className="flex items-start gap-3 rounded-lg border border-[#27272A] bg-[#18181B] p-4 text-left transition-colors hover:border-[#6366F1]/30 hover:bg-[#18181B] disabled:opacity-50"
              >
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-sm rounded-xl border border-[#27272A] bg-[#18181B] p-6 shadow-lg">
        ...
        <p className="mt-2 text-sm text-[#A1A1AA]">
          ...
          <span className="font-medium text-[#FAFAFA]">{notebookTitle}</span>?
      ...
      >
        <div className="space-y-8">
          <div className="text-center py-16">
            <p className="text-[15px] text-[#A1A1AA] mb-4">No notebooks yet</p>
            <button
