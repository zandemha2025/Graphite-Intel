...
const GRADIENTS = [
  "from-[#FED7D7] to-[#FEB2B2]",
  "from-[#FEEBC8] to-[#FBD38D]",
  "from-[#C6F6D5] to-[#9AE6B4]",
  "from-[#E9D8FD] to-[#D6BCFA]",
  "from-[#BEE3F8] to-[#90CDF4]",
  "from-[#FED7E2] to-[#FBB6CE]",
];
...
export default function ExplorePage() {
  ...
  const createConversation = useCallback(
    async (title: string): Promise<number> => {
      const conv = await apiPost<Conversation>("/openai/conversations", { title });
  ...
  /* ---------- Shared Chat Input ---------- */
  const chatInput = (
    <div className={cn("bg-white px-4 py-3", !isHomeView && "border-t border-[#E5E5E3]/60")}>
              ...
              <div className="w-full">
                <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
                  {conversations.slice(0, 6).map((conv, i) => (
                    ...
                    >
                      <div className={cn("h-12 bg-gradient-to-br", GRADIENTS[i % GRADIENTS.length])} />
                      <div className="p-3">
  ...
  return (
    <div className="h-full flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="flex items-center gap-3 border-b border-[#E5E5E3]/60 bg-white px-5 py-3 shrink-0">
          ...
          <div className="max-w-3xl mx-auto py-6 px-6 space-y-6">
            ...
            {isStreaming && streamingContent === "" && pairs.length > 0 && (
              <div className="flex items-center gap-2 py-4">
                ...
                <span className="text-xs text-[#A3A3A3] ml-1">Thinking...</span>
              </div>
            )}
          </div>
        </div>
