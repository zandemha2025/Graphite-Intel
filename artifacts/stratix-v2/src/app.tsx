...
const PlaybookEdit = lazy(() => import("@/pages/playbook-edit"));
const PlaybookRun = lazy(() => import("@/pages/playbook-run"));
const AdsDashboard = lazy(() => import("@/pages/ads-dashboard"));
const AdsCampaignNew = lazy(() => import("@/pages/ads-campaign-new"));
const AdsCampaignDetail = lazy(() => import("@/pages/ads-campaign-detail"));
const Knowledge = lazy(() => import("@/pages/knowledge"));
const Context = lazy(() => import("@/pages/context"));
const Vault = lazy(() => import("@/pages/vault"));
const VaultSearch = lazy(() => import("@/pages/vault-search"));
const VaultProject = lazy(() => import("@/pages/vault-project"));
...
const SharedItems = lazy(() => import("@/pages/shared"));
